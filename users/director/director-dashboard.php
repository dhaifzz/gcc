...
<head>
    ...
    <title>GCC Director Dashboard</title>
    <?php includeGoogleFonts(); ?>
    <link rel="stylesheet" type="text/css" href="css/director-dashboard.css">
...
<body>
    <div class="sidebar">
        ...
        <div class="menu-items">
            <a href="director-dashboard.php" style="background-color: rgb(255, 255, 255); color: #236641;"><i class="fa-solid fa-gauge"></i> Dashboard</a>
