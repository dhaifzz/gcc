...
try {
    $stmt = $pdo->prepare("SELECT a.*, u.first_name, u.middle_name, u.last_name,
                          ...
                          WHERE a.status = 'evaluated' AND a.appointment_type = 'counseling'");
    $stmt->execute();
...
<link rel="icon" type="image/x-icon" href="/gcc/img/favicon.ico">
    <title>GCC Director - Counseling Requests</title>
...
<body>
    <div class="sidebar">
        ...
        <div class="menu-items">
            ...
            <a href="director-counseling.php" style="background-color: rgb(255, 255, 255); color: #236641;"><i class="fa-regular fa-calendar-days"></i>Counseling Table</a>
        ...
        <div class="data-table-container">
            <?php if (empty($appointments)): ?>
                <div class="empty-state">
                    ...
                    <h3>No Evaluated Counseling Requests</h3>
                    <p>There are currently no counseling requests that have been evaluated by staff.</p>
                </div>
            <?php else: ?>
    ...
    <div id="approveModal" class="modal">
        <div class="modal-content confirmation-modal">
            ...
            <div class="modal-body">
                <p class="confirmation-message">Are you sure you want to approve this counseling request for:</p>
    ...
    <div id="rejectModal" class="modal">
        <div class="modal-content confirmation-modal">
            ...
            <div class="modal-body">
                <p class="confirmation-message">Are you sure you want to reject this counseling request for:</p>
                <div class="confirmation-details">
                    <div class="detail-row">
                        <strong>Client:</strong>
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            img.onerror = function() {
                                ...
                                $('#clientProfileImage').attr('src', '/gcc/img/profiles/default-profile.png');
                            };
