...
try {
    $stmt = $pdo->prepare("SELECT a.*, u.first_name, u.middle_name, u.last_name 
                           ...
                           WHERE (a.status = 'pending' OR a.status = 'approved') AND a.appointment_type = 'counseling'");
    $stmt->execute();
...
<head>
    ...
    <title>GCC Staff - Counseling Requests</title>
...
<body>
    <div class="sidebar">
        ...
        <div class="menu-items">
            ...
            <a href="staff-counseling.php" style="background-color: rgb(255, 255, 255); color: #236641;"><i class="fa-regular fa-calendar-days"></i>Counseling Table</a>
        ...
        <div class="data-table-container">
            <?php if (empty($appointments)): ?>
                <div class="empty-state">
                    ...
                    <h3>No Pending Counseling Requests</h3>
                    <p>There are currently no counseling requests awaiting evaluation.</p>
                </div>
            <?php else: ?>
    ...
    <div id="filterModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2><i class="fas fa-filter"></i> Filter Counseling</h2>
    ...
    <div id="evaluateModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to evaluate the counseling appointment for:</p>
    ...
    <div id="rescheduleModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to reschedule the counseling appointment for:</p>
                <div class="confirmation-details">
    ...
    <div id="completeModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to mark this counseling appointment as completed for:</p>
                <div class="confirmation-details">
    ...
    <div id="cancelModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to cancel this counseling appointment for:</p>
                <div class="confirmation-details">
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#appointmentsTable').DataTable({
                ...
                language: {
                    emptyTable: "No counseling requests available",
