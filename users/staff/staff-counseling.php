                    ...
                    <tr style="border: 1px solid #ddd;">
                        ...
                        <td style="padding: 12px; border: 1px solid #ddd;">
                            <form method="post" style="display: inline;">
                                ...
                                <button type="submit" name="action" value="evaluate" style="padding: 8px 12px; margin-right: 5px; background-color: #4CAF50; color: white; border: none; cursor: pointer;">Evaluated</button>
                            </form>
