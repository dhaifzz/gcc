    ...
    <div class="contents">
       <div class="image-gallery">
            <div class="image-item">
                   ...
                   <p style="margin: 15px 5px 20px; cursor: pointer;"><a href="../director/director-counseling.php" style="text-decoration: none; color: inherit;"><i class="fas fa-angle-right" style="margin-right: 5px; color:rgb(14, 72, 45);"></i>Counseling</a></p>
                   <span class="description"> Pending Counseling request</span>
            </div>
            <div class="image-item">
                   <img src="/gcc/img/assessment-img.png" alt="Image 2">
                   <p style="margin: 15px 5px 20px; cursor: pointer;"><a href="../director/director-assessment.php" style="text-decoration: none; color: inherit;"><i class="fas fa-angle-right" style="margin-right: 5px; color:rgb(14, 72, 45);"></i>Assessment for Students</a></p>
            ...
            <div class="image-item">
                   ...
                   <p style="margin: 15px 5px 20px; cursor: pointer;"><a href="../director/director-shifting.php" style="text-decoration: none; color: inherit;"><i class="fas fa-angle-right" style="margin-right: 5px; color:rgb(14, 72, 45);"></i>Shifting Exam</a></p>
