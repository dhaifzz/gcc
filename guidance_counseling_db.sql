...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2025 at 04:29 PM
...
CREATE TABLE `users` (
  ...
  `wmsu_id` varchar(9) DEFAULT NULL,
...
--
ALTER TABLE `logs`
  ADD CONSTRAINT `logs_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
