...
<body>
    ...
    <div style="background-color: #16633F; width: 100%; height: 200px; font-size: 40px; font-weight: 500; color: white; display: flex; justify-content: center; align-items: center;">
        Shifting Exam Form
    </div>

    <div class="shift-form" style="padding: 70px 50px; background-color: #2c662d;">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div style="display: flex; width: 100%; gap: 20px;">
                ...
                <div style="flex: 1; display: flex; flex-direction: column;">
                    ...
                    <input type="text" id="middle_name" name="middle_name" value="<?php echo htmlspecialchars($middleName); ?>" style="font-size: 25px; width: 100%; border-radius: 4.41px; border: 3px solid #0b3822; padding: 5px 0 5px 0; margin-top: 5px;" readonly>
                </div>
            </div>
            ...
            <div style="display: flex; width: 100%; gap: 20px; margin-top: 20px;">
                ...
                <div style="flex: 1; display: flex; flex-direction: column;">
                    <label for="school_id" style="font-size: 25px; color: white;">School ID*</label>
            ...
            <div style="display: flex; width: 100%; gap: 20px; margin-top: 20px;">
                <div style="flex: 1; display: flex; flex-direction: column;">
                    <label for="current_course" style="font-size: 25px; color: white;">Current Course*</label>
                    <input type="text" id="current_course" name="current_course" value="<?php echo htmlspecialchars($currentCourse); ?>" required style="font-size: 25px; width: 100%; border-radius: 4.41px; border: 3px solid #0b3822; padding: 5px 0 5px 0; margin-top: 5px;" readonly>
                </div>
                <div style="flex: 1; display: flex; flex-direction: column;">
                    <label for="course_to_shift" style="font-size: 25px; color: white;">Course to Shift*</label>
                    <select id="course_to_shift" name="course_to_shift" required style="font-size: 25px; width: 100%; border-radius: 4.41px; border: 3px solid #0b3822; padding: 5px 0 5px 0; margin-top: 5px;">
            ...
            <div style="width: 100%; margin-top: 20px;">
                <div style="display: flex; flex-direction: column;">
                    ...
                    <textarea id="reason_to_shift" name="reason_to_shift" required style="font-size: 25px; width: 100%; border-radius: 4.41px; border: 3px solid #0b3822; padding: 5px; margin-top: 5px; min-height: 100px; resize: none;"></textarea>
                </div>
            </div>
            ...
            <div style="margin-top: 50px; text-align: center;">
                <button class="submit" type="submit" style="padding: 10px 30px; font-size: 25px; background-color: #16633F; color: white; border: none; border-radius: 5px;">Submit</button>
            </div>
        </form>
    </div>
