    ...
    <div class="contents">
       <div class="image-gallery">
            ...
            <div class="image-item">
                   ...
                   <p style="margin: 15px 5px 20px; cursor: pointer;"><a href="../staff/staff.php" style="text-decoration: none; color: inherit;"><i class="fas fa-angle-right" style="margin-right: 5px; color:rgb(14, 72, 45);"></i>Shifting Exam</a></p>
